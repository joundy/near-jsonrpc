...
export const EXPERIMENTALMaintenanceWindows = defineMethod<RpcMaintenanceWindowsRequest, Range_of_uint64[], RpcError>("EXPERIMENTAL_maintenance_windows", RpcMaintenanceWindowsRequestSchema, z.array(Range_of_uint64Schema), RpcErrorSchema);
...
export const EXPERIMENTALValidatorsOrdered = defineMethod<RpcValidatorsOrderedRequest, ValidatorStakeView[], RpcError>("EXPERIMENTAL_validators_ordered", RpcValidatorsOrderedRequestSchema, z.array(ValidatorStakeViewSchema), RpcErrorSchema);
...
export const health = defineMethod<RpcHealthRequest, RpcHealthResponse | null, RpcError>("health", RpcHealthRequestSchema, z.union([RpcHealthResponseSchema, z.null()]), RpcErrorSchema);
